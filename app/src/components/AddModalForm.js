      ...
      <form class="space-y-5">
        <div class="flex items-center space-x-6">
          ...
          <div>
            ...
            <input type="text" id="name" placeholder="Enter name..." class="w-full border border-[#DFE2E9] rounded-lg px-3 py-2 text-[#C9CFDA] placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-purple-600 focus:border-purple-600" />
          </div>
  
          <div>
            <label for="quantity" class="block text-primary text-sm font-bold mb-1">Quantity</label>
            <input type="number" id="quantity" value="0" class="w-full border border-[#DFE2E9] rounded-lg px-3 py-2 text-[#667085] font-primary focus:outline-none focus:ring-1 focus:ring-purple-600 focus:border-purple-600" />
          </div>
  
          <div>
            <label for="price" class="block text-primary text-sm font-bold mb-1">Price</label>
            <input type="number" id="price" value="0" class="w-full border border-[#DFE2E9] rounded-lg px-3 py-2 text-[#667085] font-primary focus:outline-none focus:ring-1 focus:ring-purple-600 focus:border-purple-600" />
          </div>
          ...
          <div class="flex space-x-4">
            <div class="flex-1">
              ...
              <div class="product-status relative">
                <select id="status" class="appearance-none w-full border border-[#DFE2E9] rounded-lg px-3 py-2 text-primary focus:outline-none focus:ring-1 focus:ring-purple-600 focus:border-purple-600">
          ...
          <div>
            ...
            <input type="text" id="brand" placeholder="Enter Brand..." class="w-full border border-[#DFE2E9] rounded-md px-3 py-2 text-gray-400 placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-purple-600 focus:border-purple-600" />
          </div>
  
          <div class="flex justify-end space-x-3 mt-4">
            <button id="cancel-button" type="button" class="px-5 py-2 rounded-lg border border-[#DFE2E9] font-primary font-semibold text-sm hover:bg-gray-50 focus:outline-none">Cancel</button>
